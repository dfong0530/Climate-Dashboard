...
const Overview = () => {
    return (
        <>
            <h3 className="overview-tit">About</h3>
            <div className="overview-little">
                <p>               
            ...
            <h3 className="overview-tit">Understanding the Data</h3>
            <p>
                Temperature: Celsius
            ...
            <p>
                ...
                My goal of this project was to demonstrate my skills in React. 
                Because of that I didn't look super in depth in the accuracy of the data.
            </p>
